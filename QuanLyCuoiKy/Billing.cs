    ...
    public partial class Billing : Form
    {
        ...
        private void AddToBillBtn_Click(object sender, EventArgs e)
        {
            ...
            } else
            {
                ...
                UpdateItems();
                Methods Obj1 = new Methods();
                Obj1.DisplayData1("ItemTb1", ItemsDGV);
        ...
        private void GrdTotalss_Click(object sender, EventArgs e)
        {

        }

        private void ReportBill_Click(object sender, EventArgs e)
        {
            RepotBill Obj = new RepotBill();
            Obj.ShowDialog();
        }
